    ...
    <section className="relative min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-primary/10 to-accent/20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          {/* Logo Icon */}
          <img src="/src/logo.jpeg" alt="Sri Havens" className="w-20 h-20" style={{ borderRadius: '50%', overflow: 'hidden', justifyContent: 'center', alignItems: 'center', display: 'inline-block'}}/>
